                    ...
                    <div className="rewards">
                        ...
                        <div className="rewards1">
                            <div className="rewards11">
                                <ul>
                                    <li>Upto 50 students: Free lodging; fooding; 100% free study</li>
                                    <li>Upto 100 students(50 girls and 50 boys): 100% free education </li>
                                    <li>Upto 200 students (100 girls and 100 boys):100% scholarship on Tuition fee</li>
                                    <li>10% additional discount for girls candidate; child of army personal and teachers.</li>
                                </ul>
                            </div>
                            <div className="rewards12">
                                ...
                                <b><em>Topper of good schools will get waiver on registration fee on the recommendations of school principal.</em></b>
                            </div>
                        </div>
                    </div>
                </div>
