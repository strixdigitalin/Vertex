      ...
      <div className="main4">
        ...
        <div className="main41">
          ...
          <ul>
            ...
            <li>Regular doubt clearing classes by the same faculty team</li>
            <li>Well planned academic curriculum</li>
            <li>Well trained and well behaved, support staﬀs</li>
            <li>Parental caring of students</li>
            <li>
              Focused and disciplined teaching to generate excellent result.
            </li>
            <li>Regular tests with detailed analysis of test performance.</li>
            <li>
              Easy access of teachers for the students as well as parents.
            </li>
            <li>Well designed study material</li>
            <li>Excellent infrastructure with air-conditioned classroom.</li>
            <li>
              Special study material, classes and test for KVPY, Olympiads &
              NTSE.
            </li>
            <li>
              Special rank enhancement study material for rapid revision of
              entire syllabus
            </li>
          </ul>
        </div>
